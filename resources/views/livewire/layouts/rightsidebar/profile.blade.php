<div class="topbar-item">
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
        <!--begin::Header-->
        <div class="offcanvas-header d-flex align-items-center justify-content-end pb-5">
                    ...
                    <div class="navi mt-2">
                        <a href="#" class="navi-item">
                            <span class="navi-link p-0 pb-2">
                                ...
                                <span class="navi-text text-muted text-hover-primary"><a href="mailto:{{ $user->email }}">{{ $user->email }}</a></span>
                            </span>
                        </a>
                ...
                <a href="{{ route('user.show', auth()->user()) }}" class="navi-item">
                    <div class="navi-link">
                        ...
                        <div class="navi-text">
                            ...
                            <div class="text-muted">Configura tu perfil</div>
                        </div>
                    </div>
                </a>
                <a target="_blank" href="https://webmail.brandbean.mx/" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                        ...
                        <div class="navi-text">
                            <div class="font-weight-bold">Mis correos</div>
                            <div class="text-muted">Revisa tus correos institucionales</div>
                        </div>
                    </div>
                </a>
                <!--begin::Item-->
                <a href="#" class="navi-item">
                    <div class="navi-link">
                        ...
                        <div class="navi-text">
                            ...
                            <div class="text-muted"><span class="badge badge-secondary">Proximamente</span></div>
                        </div>
                    </div>
                </a>
                <!--end:Item-->
