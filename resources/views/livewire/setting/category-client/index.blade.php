<div class="col-xl-9">
        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder text-dark">Categorías de clientes <span class="text-muted mt-3 font-weight-bold font-size-sm">({{ $count }})</span></span>
                </h3>
                    ...
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @forelse ($categoryClients as $categoryClient)
                                <tr>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $categoryClient->name }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $categoryClient->description }}</span>
                                    </td>
                                    <td>
                                            ...
                                            <div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left"  style="position: initial!important;">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="position: inherit;">
                                                    ...
                                                    <ul class="navi navi-hover py-5">
                                                        <li class="navi-item" data-toggle="modal" data-target="#edit-{{ $categoryClient->id }}">
                                                        ...
                                                        <li class="navi-item" onclick="event.preventDefault(); confirmDestroy({{ $categoryClient->id }})">
                                                            <a href="#" class="navi-link">
                                                                <span class="navi-icon">
                                ...
                                @include('setting.category-client.edit')
                            @empty 
                                <!--begin::Col-->
                                <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <p class="text-gray-400 fs-4 fw-bold mb-10">Al parecer no tienes ninguna categoría de cliente.
                    <br> Ponga en marcha su CRM añadiendo su primera categoría de cliente</p>
                    <a data-toggle="modal" data-target=".create" href="#" class="btn btn-primary">Agregar categoría de cliente</a>
                </div>
    ...
    @include('setting.category-client.create')
    ...
    @section('footer')
        <script>
            ...
            function confirmDestroy(id){
                swal.fire({
                    title: "¿Estas seguro?",
                    text: "No podrá recuperar esta categoría de cliente y los clientes creados con esta categoría se quedarán sin categoría",
                    icon: "warning",
