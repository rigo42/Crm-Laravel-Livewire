        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder text-dark">Cuentas <span class="text-muted mt-3 font-weight-bold font-size-sm">({{ $count }})</span></span>
                </h3>
                    ...
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @forelse ($accounts as $account)
                                <tr>
                                    <td><span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $account->name }}</span></td>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <p class="text-gray-400 fs-4 fw-bold mb-10">Al parecer no tienes ninguna cuenta.
                    <br> Ponga en marcha su CRM añadiendo su primera cuenta</p>
                    <a data-toggle="modal" data-target=".create" href="#" class="btn btn-primary">Agregar cuenta</a>
                </div>
