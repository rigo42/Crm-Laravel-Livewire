<div class="col-xl-9">
        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder text-dark">Categorías de gastos <span class="text-muted mt-3 font-weight-bold font-size-sm">({{ $count }})</span></span>
                </h3>
                    ...
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @forelse ($categoryExpenses as $categoryExpense)
                                <tr>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $categoryExpense->name }}</span>
                                    </td>
                                    <td>
                                        @if ($categoryExpense->services)
                                            <span class="font-weight-bolder font-size-lg badge badge-success">{{ $categoryExpense->services->count() }}</span>
                                        @else
                                            ...
                                            <div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left"  style="position: initial!important;">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="position: inherit;">
                                                    ...
                                                    <ul class="navi navi-hover py-5">
                                                        <li class="navi-item" data-toggle="modal" data-target="#edit-{{ $categoryExpense->id }}">
                                                        ...
                                                        <li class="navi-item" onclick="event.preventDefault(); confirmDestroy({{ $categoryExpense->id }})">
                                                            <a href="#" class="navi-link">
                                                                <span class="navi-icon">
                                ...
                                @include('setting.category-expense.edit')
                            @empty 
                                <!--begin::Col-->
                                <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <p class="text-gray-400 fs-4 fw-bold mb-10">Al parecer no tienes ninguna categoría de gasto.
                    <br> Ponga en marcha su CRM añadiendo su primera categoría de gasto</p>
                    <a data-toggle="modal" data-target=".create" href="#" class="btn btn-primary">Agregar categoría de gasto</a>
                </div>
    ...
    @include('setting.category-expense.create')
    ...
    @section('footer')
        <script>
            ...
            function confirmDestroy(id){
                swal.fire({
                    title: "¿Estas seguro?",
                    text: "No podrá recuperar esta categoría de gasto y los gastos creados con esta categoría se quedarán sin categoría",
                    icon: "warning",
