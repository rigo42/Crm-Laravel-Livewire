    ...
    <div wire:ignore.self class="modal fade" data-backdrop="static" id="invoiceFormModal" tabindex="-1" aria-labelledby="invoiceFormModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @livewire('invoice.form', ['method' => 'storeCustom'])
                </div>
                <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Regresar</button>
                </div>
            ...
            <form class="form" wire:submit.prevent="{{ $method }}">
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="my-5" x-data="invoice()">
                            <h3 class="text-dark font-weight-bold mb-10">Datos de facturación</h3>
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label class="col-form-label">¿Tendrá factura?</label>
                                    <div class="col-3">
                                        <span class="switch switch-outline switch-icon switch-primary">
                                            <label>
                                                <input 
                                                    x-on:click="toogleInvoice()"
                                                    wire:model.defer="payment.has_invoice"
                                                    class="@error('payment.has_invoice') is-invalid @enderror"
                                                    type="checkbox" />
                                                <span></span>
                                            </label>
                                        </span>
                                        @error('payment.has_invoice') <div><span class="text-danger">{{ $message }}</span></div> @enderror
                                    </div>
                                </div>
                                <div 
                                    class="col-lg-6" 
        ...
        <script>
            ...
            function invoice(){
                return {
                    ...
                    hasInvoice : Boolean({{ $payment->has_quotation ? 'true' : 'false' }}),
