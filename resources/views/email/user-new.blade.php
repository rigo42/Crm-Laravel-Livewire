...
<head>
    ...
    <title>Nuevo usuario BrandBean</title>
    <style type="text/css">
        body {
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                                                            ...
                                                                            <tr>
                                                                                <td align='left'>
                                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                                        <div class="contentEditable" align='center'>
                                                                                            <p>Hola {{ $user->name }}, utiliza este correo y tu contraseña {{ $password }} para iniciar sesión en el <a href="{{ config('app.url') }}" target="_blank" rel="noopener noreferrer">administrador de BrandBean</a> </p>
                                                                                                        ...
                                                                                                        <div class="contentEditableContainer contentTextEditable">
                                                                                                            <div class="contentEditable" align='center'>
                                                                                                                <p style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                                                                                                    <span style='font-weight:bold;'>BrandBean Marketing Desing</span>
                                                                                                                </p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </td>
