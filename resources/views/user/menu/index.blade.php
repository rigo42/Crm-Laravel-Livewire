    ...
    <div class="card card-custom card-stretch">
        ...
        <div class="card-body pt-20">
            ...
            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                ...
                @if($user->can('gastos'))
                <div class="navi-item mb-2">
                    <a href="{{ route('user.expense', $user) }}" class="navi-link py-4 {{ active('user.expense') }}">
                        <span class="navi-icon mr-2">
                            <span class="svg-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Shopping\Calculator.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <span class="navi-text font-size-lg">Gastos</span>
                    </a>
                </div>
                @endif 
